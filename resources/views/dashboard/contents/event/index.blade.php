<a href="/event/create" class="px-5 py-2 bg-main rounded text-white text-decoration-none">Buat Jadwal</a>
    ...
    <div class="col">
      <div class="card">
        ...
        <div class="grid-button px-3 py-3">
          <a href="/event/{{$data->id}}/edit" class="d-flex align-items-center justify-content-center py-1 bg-warning rounded text-white text-decoration-none text-center">Edit</a>
    ...
    <div class="modal fade" id="{{'hapus-'.$data->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <h5>Yakin ingin menghapus jadwal ?</h5>
          </div>
          <div class="modal-footer">
