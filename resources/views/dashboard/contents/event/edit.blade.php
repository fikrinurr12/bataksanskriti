...
<form action="/event/{{$data_event->id}}" method="post" class="me-3" enctype="multipart/form-data">
    ...
    <div class="input-group flex-nowrap my-3">
        ...
        <input value="{{$data_event->judul}}" type="text" class="form-control" name="judul" id="judul" placeholder="" aria-label="Username" aria-describedby="addon-wrapping" required>
    </div>
